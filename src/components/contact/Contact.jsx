            ...
            <Jumbotron className="contact-jumbotron">
                <Row>
                    <Col className="d-flex justify-content-center flex-wrap">
                        <div className="m-2">
                            <a href="mailto:johnogenyi4real@gmail.com" target="_blank" rel="noopener noreferrer">
                                <Button variant="outline-danger" title="johnogenyi4real@gmail.com">
                        ...
                        <div className="m-2">
                            <a href="https://www.facebook.com/john.otor3" target="_blank" rel="noopener noreferrer">
